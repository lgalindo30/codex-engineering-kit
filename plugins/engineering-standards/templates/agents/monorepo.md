...
- The parent agent assigns project boundaries, file ownership, contracts, and acceptance criteria before delegating independent tasks. One owner must coordinate root configuration and lockfile changes.
