...
description: Implement standalone Bun and TypeScript backends, including HTTP APIs, persistence, integrations, and deployment. Use when Bun is the selected backend runtime.
---

# Bun Backend

Use this skill for Bun backend work. Preserve the requested framework; Hono and Zod are useful
defaults for a new API. Keep Bun-only APIs out of browser code and portable packages.
