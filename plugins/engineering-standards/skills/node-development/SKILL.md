...
description: Implement standalone Node.js and TypeScript backends, including HTTP APIs, persistence, integrations, and deployment. For an integrated Next.js application use nextjs-development.
---

# Node.js Backend

Use this skill for standalone Node.js backend work. Preserve the requested framework; Hono is a
lightweight default when none is specified. Node.js plus Next.js can describe one integrated application
and does not itself require a separate API service.
