...
description: Build or change Next.js applications, including server/client rendering and integrated server behavior. Use for Next.js on Node.js without assuming a separate backend.
---

# Next.js Application

Use this skill for Next.js application work, including integrated server behavior. Preserve the router
and requested runtime. Create a separate backend only when the scope or existing architecture calls
for it; Node.js plus Next.js can be one application.
